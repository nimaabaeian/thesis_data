...
_Generated 2026-07-13T10:37:17+00:00_
...
- branch: `fix/statistical-audit-corrections`
- commit: `8554b80dc1447e28e6f6aa76de5df4b7406f812d`
...
| `outputs/b10_scheduled_day_panel.csv` | `a0aec675a52197de` |
...
| `outputs/b5_ping_response_windows.csv` | `d4b04ba95d797671` |
...
| `outputs/quality_report.md` | `08e126edd160e829` |
| `outputs/results_summary.md` | `fba313ff5ee789b6` |
...
| `outputs/success_criteria.csv` | `f60614f0b5e37fc8` |
| `outputs/verification_report.md` | `20f44d340543af90` |
...
| `figures/fig08_remote_loop.png` | `f40a92ee8d919da7` |
